...
usage() {
  echo "Usage: $0 {jwt|jwt_1k|jwt_2k|jwt_4k|jwt_8k|show|prepare_2vc|prepare_2vc_1k|prepare_2vc_2k|prepare_2vc_4k|prepare_2vc_8k|show_2vc|ecdsa|all}"
  ...
  echo "  prepare_2vc*: Compile the two-credential Prepare circuit variants."
  echo "  show_2vc: Compile the two-credential Show circuit."
...
case "$1" in
  jwt|jwt_1k|jwt_2k|jwt_4k|jwt_8k|show|prepare_2vc|prepare_2vc_1k|prepare_2vc_2k|prepare_2vc_4k|prepare_2vc_8k|show_2vc|ecdsa)
    compile_circuit "$1"
    ;;
  all)
